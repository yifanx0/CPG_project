...
* `wxxx.csv`: this contains movement (i.e. sales) data on the UPC/store/week level. [^1]
* `xxx_merge.csv`: this file contains an inner merge of the data in `wxxxsh.csv` and `wxxx.csv`. 

[^1]: Descriptions for `wxxxsh.csv` and `wxxx.csv` are omitted, as their data structures are identical to that of `xxx_merge.csv`, since it is a merging of the two.

## `upcxxx.csv` data structure
