...
products = fread("raw/product_char_beer.csv", sep="auto", sep2=NULL,
                 nrows=-1L, header=TRUE, na.strings=c(""), 
                 stringsAsFactors=FALSE, verbose=TRUE, autostart=30L,
                 skip=-1L, select=NULL, drop=NULL, colClasses=products_colclass,
...
movements = fread("raw/movement_beer.csv", sep="auto", sep2=NULL,
                  nrows=-1L, header=TRUE, na.strings=c("", "."), 
                  stringsAsFactors=FALSE, verbose=TRUE, autostart=30L,
                  skip=-1L, select=NULL, drop=NULL, colClasses=movements_colclass,
                  showProgress=TRUE, data.table = TRUE)
